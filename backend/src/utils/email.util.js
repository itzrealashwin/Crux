...
export const sendOTPEmail = async (toEmail, otp) => {
  ...
  transporter.sendMail({
    from: `"Project Crux" <${process.env.EMAIL_USER}>`,
    to: toEmail,
    subject: ` ${otp} is your Project Crux verification code`,
    html: `
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: ${secondaryColor}; max-width: 600px; margin: 0 auto; border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
        ...
        <div style="background-color: ${brandColor}; padding: 20px; text-align: center;">
          <h1 style="color: #ffffff; margin: 0; font-size: 24px; letter-spacing: 1px;">Project Crux</h1>
        ...
        <div style="padding: 40px 30px; background-color: #ffffff;">
          ...
          <p>Hello,</p>
          <p>You are receiving this email because a request was made to access your <strong>Project Crux</strong> account. Use the verification code below to proceed:</p>
        ...
        <div style="background-color: #f1f5f9; padding: 20px; text-align: center; font-size: 12px; color: #94a3b8;">
          <p style="margin: 0;">&copy; ${new Date().getFullYear()} Project Crux | Educational Placement Portal</p>
